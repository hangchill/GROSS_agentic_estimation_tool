...
# b. Search for top-2 similar functionalities  (based on current functionallity description being assessed)
# c. From the functionalities-effortGrp mappings present, 
#     i. eval the effort groupings for appropriatenness in ASSESSMENT CONTEXT
